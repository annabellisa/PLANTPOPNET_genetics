...
arrows(head(which(sdat.thisrun$region=="Europe" & sdat.thisrun$native=="native"),1),-0.25,tail(which(sdat.thisrun$region=="Europe" & sdat.thisrun$native=="native"),1),-0.25,lwd=1.5,code=0)
...
arrows(head(c(which(sdat.thisrun$c_code=="AU"),which(sdat.thisrun$c_code=="NZ")),1),-0.25,tail(c(which(sdat.thisrun$c_code=="AU"),which(sdat.thisrun$c_code=="NZ")),1),-0.25,lwd=1.5,code=0)
...
arrows(head(which(sdat.thisrun$native=="cultivar"),1),-0.25,tail(which(sdat.thisrun$native=="cultivar"),1),-0.25,lwd=1.5,code=0)
mtext("Cultivar",at=which(sdat.thisrun$native=="cultivar")[length(which(sdat.thisrun$native=="cultivar"))/2],side=1,line=4, cex=1.5)

# Add labels for native / non-native:

arrows(head(which(sdat.thisrun$region=="Europe" & sdat.thisrun$native=="native"),1),1.05,tail(which(sdat.thisrun$region=="Europe" & sdat.thisrun$native=="native"),1)-1,1.05,lwd=1.5,code=3,angle=90,length=0.05)
